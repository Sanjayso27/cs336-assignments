...
def run_multihead_self_attention(
    ...
    """
    mha = MultiHeadSelfAttention(d_model,num_heads,attn_pdrop)
    mha.load_state_dict_custom(weights)
...
def run_transformer_lm(
    ...
    """
    transformer_lm = TransformerLM(vocab_size, context_length, num_layers, d_model, 
                                   num_heads, d_ff, attn_pdrop, residual_pdrop)
...
def get_tokenizer(
    ...
    """
    return tokenizer_me.Tokenizer(vocab, merges, special_tokens)
    ...
    Returns:
        Tuple of (vocab, merges):
            ...
            merges: list[tuple[bytes, bytes]]
                ...
                Merges are ordered by order of creation.
    """
    return train_bpe_me.train_bpe(input_path, vocab_size, special_tokens)